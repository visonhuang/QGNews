...
public class ManagerPersonEAdapter extends ArrayAdapter<Manager> {

    private int resourceId;


    public ManagerPersonEAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<Manager> objects) {
